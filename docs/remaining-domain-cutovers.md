...
Sam visually accepted all three batch-3 domains on iPhone and pushed 4da53d7. Batch 4 preparation and exact rollback values are recorded in [batch4-cutover.md](batch4-cutover.md). Adaprise remains pending its user-managed registration transfer and explicit DNS setup.
