...
| `https://portal.guten.ink/` | Guten Portal home, behind authentication once implemented |
...
No DNS records, production hostname rules, custom-domain rewrites, TLS certificates, or authentication are configured by this root-page change.
