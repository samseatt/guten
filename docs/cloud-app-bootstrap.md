...
Portal HTTPS deployment and rollback results are now recorded in [Portal-first launch](portal-launch.md). Earlier pending checkpoints above are historical; real browser OAuth acceptance has since passed; public-site/content cutover remains ahead.
